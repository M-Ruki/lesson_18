...
def place_food():
    ...
    while True:
        ...
        if (x, y) not in snake:
            ...
            break
    while True:
        bomb_x = random.randrange(GRID_W)
        bomb_y = random.randrange(GRID_H)
        if (bomb_x, bomb_y) not in snake:
            bomb = (bomb_x,bomb_y)
            break
